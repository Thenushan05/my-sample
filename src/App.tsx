              ...
              {!isSpiderman ? null : (
                <div className="w-full max-w-5xl mx-auto py-16 px-4 sm:px-6 relative z-10">
                  ...
                  <div className="relative rounded-2xl overflow-hidden border-2 border-red-600/50 shadow-[0_0_40px_rgba(220,38,38,0.35)] bg-[#090a0f]/95 backdrop-blur-md flex flex-col h-[580px] transition-all duration-500">
                    ...
                    {/* HUD Corner Brackets */}
                    <div className="absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-red-500 z-30 pointer-events-none transition-colors" />
                    <div className="absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 border-blue-500 z-30 pointer-events-none transition-colors" />
                    <div className="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-blue-500 z-30 pointer-events-none transition-colors" />
                    <div className="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-red-500 z-30 pointer-events-none transition-colors" />

                    {/* Window Top Bar / HUD Banner */}
                    <div className="w-full bg-gradient-to-r from-[#1c0808] via-[#0f0714] to-[#081226] border-b border-red-500/30 px-4 py-2.5 flex items-center justify-between z-20 transition-colors">
                      {/* Left: Window Control Dots & Logo */}
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1.5">
                          <div className="w-3 h-3 rounded-full bg-red-500/90 shadow-[0_0_8px_rgba(239,68,68,0.6)]" />
                        ...
                        {/* Logo Area */}
                        <div className="flex items-center gap-1.5 pl-2 border-l border-white/10 text-red-500 transition-colors">
