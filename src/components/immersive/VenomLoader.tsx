    ...
    <AnimatePresence>
      {!isLoaded && (
        <motion.div
          ...
          className="fixed inset-0 z-[99999] flex flex-col items-center justify-center overflow-hidden bg-[#050506]"
        >
          ...
          <motion.div
            ...
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_18%,rgba(20,21,23,0.55)_62%,rgba(5,3,8,1)_100%)]"
          />
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[58vw] w-[58vw] -translate-x-1/2 -translate-y-1/2 rounded-full bg-zinc-600/20 blur-[120px]" />
          ...
          >
            ...
            <defs>
              <linearGradient id="venom-claw" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="60%" stopColor="#b9c2cd" />
          ...
          >
            ...
            >
              <VenomSpiderIcon className="h-full w-full drop-shadow-[0_0_30px_rgba(185,194,205,0.95)]" />
            </motion.div>
          </motion.div>
          ...
          <div className="mt-10 w-56 sm:w-72">
            <div
              className="mb-1.5 flex justify-between text-[10px] tracking-[0.28em] text-zinc-200/70"
              style={{ fontFamily: "'Creepster', cursive" }}
            >
              <span>Bonding</span>
              <span className="text-[#e9edf2]">98%</span>
            </div>
            <div className="h-2.5 rounded-full border border-[#b9c2cd]/40 bg-black/70">
              <motion.div
                initial={{ width: "0%" }}
                animate={{ width: "98%" }}
                transition={{ duration: 2.7, ease: "easeInOut" }}
                className="h-full rounded-full bg-gradient-to-r from-[#17181b] via-[#6b7280] to-[#f4f7fb] shadow-[0_0_14px_#b9c2cd]"
              />
            </div>
          </div>
          ...
          <div className="mt-6 h-7">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="text-[12px] tracking-[0.3em] text-zinc-100/80"
                style={{ fontFamily: "'Creepster', cursive" }}
              >
                {WHISPERS[whisperIdx]}
              </motion.div>
