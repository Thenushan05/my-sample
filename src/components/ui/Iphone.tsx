  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* JARVIS Iron Man HUD Overlay */}
        <g className="opacity-0 [.ironman_&]:opacity-100 transition-opacity duration-500 pointer-events-none">
          {/* Main glowing border */}
          <rect x="0" y="0" width="430" height="882" fill="none" stroke="#06b6d4" strokeWidth="3" opacity="0.6" className="filter drop-shadow-[0_0_10px_#06b6d4]" />
          <rect x="5" y="5" width="420" height="872" fill="none" stroke="#06b6d4" strokeWidth="1" opacity="0.3" />
          
          {/* Cyan/Amber HUD Accents */}
          <path d="M -5 30 L -5 -5 L 30 -5" fill="none" stroke="#f59e0b" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#f59e0b]" />
          <path d="M 435 30 L 435 -5 L 400 -5" fill="none" stroke="#06b6d4" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#06b6d4]" />
          <path d="M -5 852 L -5 887 L 30 887" fill="none" stroke="#06b6d4" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#06b6d4]" />
