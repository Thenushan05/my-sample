...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] dark:shadow-[0_0_20px_-12px_rgba(255,255,255,0.2)] transition-colors duration-300",
        className
      )}
    >
      {children}
...
export function SkillsBeamSection() {
  ...
  return (
    <div
      className="relative flex h-[350px] w-full items-center justify-center overflow-hidden p-6 md:p-10"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[250px] max-w-lg flex-col items-stretch justify-between gap-10">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Circle ref={div4Ref} className="size-16 border-blue-500 dark:border-blue-400 bg-blue-50/50 dark:bg-blue-950/30">
            <Icons.openai className="text-blue-500 dark:text-blue-400" />
          </Circle>
          <Circle ref={div6Ref}>
            <Icons.zapier />
          </Circle>
...
const Icons = {
  ...
  openai: ({ className }: { className?: string }) => (
    <svg
      ...
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className={cn("fill-current text-black dark:text-white transition-all duration-300", className)}
    >
  ...
  googleDocs: () => (
    ...
    >
      ...
      >
        <g id="Docs-Group">
          <g id="Docs-Clipped">
            <mask id="docs-mask-2" fill="white">
              <use xlinkHref="#docs-path-1" />
            </mask>
            <path
              ...
              fill="#4285F4"
              fillRule="nonzero"
              mask="url(#docs-mask-2)"
            />
          </g>
          <g id="Docs-Clipped-2">
            <mask id="docs-mask-4" fill="white">
              <use xlinkHref="#docs-path-3" />
            </mask>
            <polygon
              id="Docs-Path-2"
              fill="url(#docs-linearGradient-5)"
              fillRule="nonzero"
              mask="url(#docs-mask-4)"
              points="30.6638281 16.4309659 47 32.8582386 47 17.7272727"
            ></polygon>
          </g>
          <g id="Docs-Clipped-3">
            <mask id="docs-mask-7" fill="white">
              <use xlinkHref="#docs-path-6" />
            </mask>
            <path
              ...
              fill="#F1F1F1"
              fillRule="nonzero"
              mask="url(#docs-mask-7)"
            />
          </g>
          <g id="Docs-Clipped-4">
            <mask id="docs-mask-9" fill="white">
              <use xlinkHref="#docs-path-8" />
            </mask>
            <g id="Docs-Group-2" mask="url(#docs-mask-9)">
          ...
          <g id="Docs-Clipped-5">
            <mask id="docs-mask-11" fill="white">
              <use xlinkHref="#docs-path-10" />
            </mask>
            <path
              ...
              fill="#FFFFFF"
              fillRule="nonzero"
              mask="url(#docs-mask-11)"
            />
          </g>
          <g id="Docs-Clipped-6">
            <mask id="docs-mask-13" fill="white">
              <use xlinkHref="#docs-path-12" />
            </mask>
            <path
              ...
              fill="#1A237E"
              fillRule="nonzero"
              mask="url(#docs-mask-13)"
            />
          </g>
          <g id="Docs-Clipped-7">
            <mask id="docs-mask-15" fill="white">
              <use xlinkHref="#docs-path-14" />
            </mask>
            <path
        ...
        <path
          d="M29.375,0 L4.40625,0 C1.9828125,0 0,1.99431818 0,4.43181818 L0,60.5681818 C0,63.0056818 1.9828125,65 4.40625,65 L42.59375,65 C45.0171875,65 47,63.0056818 47,60.5681818 L47,17.7272727 L29.375,0 Z"
          id="Docs-Path-7"
          fill="url(#docs-radialGradient-16)"
          fillRule="nonzero"
        />
      </g>
    </svg>
