    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <g className="[.spiderman_&]:opacity-0 [.ironman_&]:opacity-0 [.deadpool_&]:opacity-0 transition-opacity duration-500">
            <circle
              cx="27"
              cy="25"
              r="6"
          ...
          <g className="opacity-0 [.spiderman_&]:opacity-100 transition-opacity duration-500 pointer-events-none">
            {/* Dark glass top bar */}
            <rect x="0" y="0" width="1202" height="52" fill="rgba(0,0,0,0.8)" />
            {/* White border */}
            <rect x="0" y="0" width="1202" height="753" fill="none" stroke="rgba(255,255,255,0.2)" strokeWidth="4" />
            <rect x="0" y="52" width="1202" height="1" fill="rgba(255,255,255,0.2)" />
            
            {/* Red accents */}
            <path d="M 0 40 L 0 0 L 40 0" fill="none" stroke="#ef4444" strokeWidth="8" />
            <path d="M 1202 713 L 1202 753 L 1162 753" fill="none" stroke="#ef4444" strokeWidth="8" />
            
            {/* Text */}
            <text x="25" y="32" fill="white" fontSize="18" fontFamily="sans-serif" fontStyle="italic" fontWeight="bold" letterSpacing="0.2em">{url}</text>
          </g>

          {/* JARVIS Iron Man HUD Frame */}
          <g className="opacity-0 [.ironman_&]:opacity-100 transition-opacity duration-500 pointer-events-none">
            {/* Tinted cyan glass top bar */}
            <rect x="0" y="0" width="1202" height="52" fill="rgba(6,182,212,0.15)" />
            {/* Glowing borders */}
            <rect x="0" y="0" width="1202" height="753" fill="none" stroke="#06b6d4" strokeWidth="2" opacity="0.6" />
            <rect x="0" y="52" width="1202" height="1" fill="#06b6d4" opacity="0.5" />
            
            {/* Amber/Cyan targeting accents */}
            <path d="M 0 30 L 0 0 L 30 0" fill="none" stroke="#06b6d4" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#06b6d4]" />
            <path d="M 1202 30 L 1202 0 L 1172 0" fill="none" stroke="#f59e0b" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#f59e0b]" />
            <path d="M 1202 723 L 1202 753 L 1172 753" fill="none" stroke="#06b6d4" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#06b6d4]" />
            <path d="M 0 723 L 0 753 L 30 753" fill="none" stroke="#f59e0b" strokeWidth="6" className="filter drop-shadow-[0_0_8px_#f59e0b]" />
            
            {/* Readout Text */}
            <text x="25" y="32" fill="#06b6d4" fontSize="16" fontFamily="monospace" fontStyle="italic" fontWeight="bold" letterSpacing="0.1em">TARGET: {url}</text>
            <text x="1050" y="32" fill="#f59e0b" fontSize="14" fontFamily="monospace" fontStyle="italic" fontWeight="bold">MARK LXXXV</text>
          </g>

          {/* Deadpool comic-panel frame: hard black keyline, blood-soaked
              title bar with drips, and a hand-lettered address line. */}
          <g className="opacity-0 [.deadpool_&]:opacity-100 transition-opacity duration-500 pointer-events-none">
            {/* Crimson title bar */}
            <rect x="0" y="0" width="1202" height="52" fill="#8f0f22" />
            <rect x="0" y="0" width="1202" height="18" fill="#c11228" />
            {/* Hard comic keyline around the whole panel */}
            <rect x="0" y="0" width="1202" height="753" fill="none" stroke="#0a0000" strokeWidth="10" />
            <rect x="10" y="10" width="1182" height="733" fill="none" stroke="rgba(220,20,60,0.5)" strokeWidth="3" />
            <rect x="0" y="52" width="1202" height="4" fill="#0a0000" />

            {/* Blood running down from the title bar */}
            {[70, 190, 340, 520, 700, 880, 1010, 1130].map((x, i) => (
              <g key={x}>
                <rect x={x} y="52" width={5 + (i % 3) * 2} height={22 + ((i * 17) % 46)} fill="#8f0f22" />
                <circle
                  cx={x + (5 + (i % 3) * 2) / 2}
                  cy={52 + 22 + ((i * 17) % 46)}
                  r={4 + (i % 3)}
            ...
            {/* Traffic lights restyled as bullet holes */}
            {[27, 47, 67].map((cx) => (
              <g key={cx}>
                <circle cx={cx} cy="25" r="7" fill="#0a0000" />
                <circle cx={cx} cy="25" r="3" fill="#dc143c" />
              </g>
            ))}

            {/* Hand-lettered address */}
            <text
              x="100"
              y="34"
              fill="#fff8e7"
          ...
          <g className="mix-blend-luminosity text-[#A3A3A3] [.luffy_&]:text-[#241a10] [.naruto_&]:text-[#2b1607] [.spiderman_&]:opacity-0 [.deadpool_&]:opacity-0 transition-opacity duration-500">
            <path
          ...
          {mode === "default" ? (
            <>
              <g className="mix-blend-luminosity text-[#A3A3A3] [.luffy_&]:text-[#241a10] [.naruto_&]:text-[#2b1607] [.spiderman_&]:text-red-500 [.ironman_&]:text-cyan-400 [.deadpool_&]:text-[#fff8e7] transition-colors duration-500">
                <path
