    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <g className="[.spiderman_&]:opacity-0 transition-opacity duration-500">
            <circle
              cx="27"
              cy="25"
              r="6"
          ...
          <path
            ...
            className="fill-[#E5E5E5] dark:fill-[#404040] [.spiderman_&]:fill-[#150505] transition-colors duration-500"
          />
          ...
          {mode === "default" ? (
            <>
              <g className="mix-blend-luminosity text-[#A3A3A3] [.spiderman_&]:text-red-500 transition-colors duration-500">
                <path
