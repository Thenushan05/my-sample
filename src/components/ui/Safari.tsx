    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <g className="[.spiderman_&]:opacity-0 [.ironman_&]:opacity-0 transition-opacity duration-500">
            <circle
              cx="27"
              cy="25"
              r="6"
          ...
          <g className="mix-blend-luminosity text-[#A3A3A3] [.spiderman_&]:opacity-0 transition-opacity duration-500">
            <path
          ...
          {mode === "default" ? (
            <>
              <g className="mix-blend-luminosity text-[#A3A3A3] [.spiderman_&]:text-red-500 [.ironman_&]:text-cyan-400 transition-colors duration-500">
                <path
