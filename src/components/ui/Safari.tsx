    ...
    >
      ...
      >
        ...
        >
          ...
          <g className="mix-blend-luminosity text-[#A3A3A3] [.spiderman_&]:opacity-0 [.deadpool_&]:opacity-0 transition-opacity duration-500">
            <path
          ...
          {mode === "default" ? (
            <>
              <g className="mix-blend-luminosity text-[#A3A3A3] [.spiderman_&]:text-red-500 [.ironman_&]:text-cyan-400 [.deadpool_&]:text-[#fff8e7] transition-colors duration-500">
                <path
