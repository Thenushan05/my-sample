...
export const ScrollStack: React.FC<ScrollStackProps> = ({
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (blurAmount) {
        ...
        for (let j = 0; j < cardsRef.current.length; j++) {
          ...
          if (jCard) {
            const jCardTop = cardOffsetsRef.current[j] !== undefined ? cardOffsetsRef.current[j] : getElementOffset(jCard);
  ...
  useLayoutEffect(() => {
    ...
    // Measure and cache initial untransformed layout top offsets
    ...
    const cleanupScroll = useWindowScroll
